...
class AssigneeMention(object):
    def __init__(self, uuid, patent_id, rawlocation_id, assignee_type,
                 raw_first, raw_last, organization, sequence, location_id=None, lat=None, lon=None, city=None,
    ...
    def from_sql_records(rec: dict):
        return AssigneeMention(uuid=rec.get('uuid', rec.get('id', None)),
                               ...
                               location_id=rec.get('location_id'), lat=rec.get('latitude'), lon=rec.get('longitude'),
...
class AssigneeNameMention(object):
    ...
    def __init__(self, uuid, name_hash, canopies, name_features, mention_ids, record_ids, location_strings,
        ...
        self.average_lat = average_latitude
        self.average_lon = average_longitude
    ...
    def from_assignee_mentions(name_hash, assignee_mentions):
        ...
        return AssigneeNameMention(anm_id, name_hash, canopies, name_features, mention_ids, record_ids,
                                   location_strings, average_latitude=average_latitude,
