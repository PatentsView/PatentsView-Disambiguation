...
def main():
    ...
    get_entity_name_new = """
        SELECT DISTINCT(organization) from tmp_assignee_disambiguation_granted INNER JOIN rawassignee ON rawassignee.uuid =tmp_assignee_disambiguation_granted.uuid WHERE disambiguated_id="%s" LIMIT 10;
        """
